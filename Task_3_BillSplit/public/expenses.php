...
<head>
    ...
    <title>Proportional Bill Split</title>
    <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
<nav class="navbar">
    <strong>Bill Split Calculator</strong>
</nav>
<main class="container">
    <section class="card">
        <h1>Fair Household Bill Split</h1>
        <p>Formula: Individual Share = (Individual Income / Combined Income) × Total Bill</p>
        ...
        <button type="button" id="addRoommate" class="secondary">Add Roommate</button>
        <button type="button" id="saveBill">Save Bill Log</button>
